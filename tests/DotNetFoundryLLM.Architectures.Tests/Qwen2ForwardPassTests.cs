...
/// <summary>Tests for <see cref="Qwen2ForwardPass"/>.</summary>
public sealed class Qwen2ForwardPassTests
{
    [Fact]
    public void Forward_ProducesFiniteLogitsWithExpectedShape()
    {
        ...
        using var weights = new Qwen2Weights(
            cfg,
            ...
            MakeJagged(cfg.LayerCount, cfg.QueryDim, 0.015f),
            MakeJagged(cfg.LayerCount, cfg.KvDim, 0.016f),
            MakeJagged(cfg.LayerCount, cfg.KvDim, 0.017f),
        ...
        var forward = new Qwen2ForwardPass(weights);
