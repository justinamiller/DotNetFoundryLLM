...
/// <summary>Tests for <see cref="MistralForwardPass"/>.</summary>
public sealed class MistralForwardPassTests
{
    [Fact]
    public void Forward_ProducesFiniteLogitsWithExpectedShape()
    {
        var cfg = new MistralConfig
        {
        ...
        var forward = new MistralForwardPass(weights, cfg);
